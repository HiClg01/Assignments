       ...
       <header className="bg-gray-900 text-white px-4 py-4 shadow-md sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <Link href="/" className="text-2xl font-bold text-gray-900">
            <span className="text-red-600">SnapKart</span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <div className="relative" ref={userMenuRef}>
              <button onClick={() => setUserMenuOpen(!userMenuOpen)}>
                <UserCircle size={32} className="text-gray-700 hover:text-red-600 transition" />
              </button>
  ...
  function NavItem({ href, label, mobile, active }) {
    return (
      <Link
        href={href}
        className={`block ${mobile ? 'w-full py-2 text-sm' : 'relative group'} ${
